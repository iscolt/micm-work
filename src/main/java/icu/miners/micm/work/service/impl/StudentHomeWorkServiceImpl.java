...
public class StudentHomeWorkServiceImpl extends AbstractCrudService<StudentHomeWork, Integer> implements StudentHomeWorkService {
    ...
    @Override
    public List<StudentHomeWork> listByHomeWork(HomeWork homeWork, short status) {
        return studentHomeWorkRepository.findAllByHomeWorkAndStatus(homeWork, status);
    }
    ...
    @Override
    public List<StudentHomeWork> findByStudent(Student student) {
        return studentHomeWorkRepository.findAllByStudentOrderBySubDateDesc(student);
    }
}
